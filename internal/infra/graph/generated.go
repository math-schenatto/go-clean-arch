...
func (ec *executionContext) field_Mutation_createOrder_argsInput(
	...
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalOOrderInput2ᚖgithubᚗcomᚋmathᚑschenattoᚋgoᚑcleanᚑarchᚋinternalᚋinfraᚋgraphᚋmodelᚐOrderInput(ctx, tmp)
	}
...
func (ec *executionContext) _Mutation_createOrder(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOOrder2ᚖgithubᚗcomᚋmathᚑschenattoᚋgoᚑcleanᚑarchᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalOOrder2ᚕᚖgithubᚗcomᚋmathᚑschenattoᚋgoᚑcleanᚑarchᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder(ctx context.Context, sel ast.SelectionSet, v []*model.Order) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalOOrder2ᚖgithubᚗcomᚋmathᚑschenattoᚋgoᚑcleanᚑarchᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalOOrder2ᚖgithubᚗcomᚋmathᚑschenattoᚋgoᚑcleanᚑarchᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder(ctx context.Context, sel ast.SelectionSet, v *model.Order) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
...
func (ec *executionContext) unmarshalOOrderInput2ᚖgithubᚗcomᚋmathᚑschenattoᚋgoᚑcleanᚑarchᚋinternalᚋinfraᚋgraphᚋmodelᚐOrderInput(ctx context.Context, v any) (*model.OrderInput, error) {
	if v == nil {
		return nil, nil
	}
